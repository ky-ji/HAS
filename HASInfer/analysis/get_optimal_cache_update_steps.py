...
#使用示例（修改对应文件路径）
#python HASInfer/analysis/get_optimal_cache_update_steps.py -c checkpoint/lift_ph/diffusion_policy_transformer/train_2/checkpoints/epoch=0250-test_mean_score=1.000.ckpt -o assets/lift_ph -d cuda:2 --num_caches '5,7,10,20' --force_recompute

#python HASInfer/analysis/get_optimal_cache_update_steps.py -c checkpoint/can_ph/diffusion_policy_transformer/train_2/checkpoints/epoch=0650-test_mean_score=1.000.ckpt -o assets/can_ph -d cuda:2 --num_caches '5,7,10,20' --force_recompute

#python HASInfer/analysis/get_optimal_cache_update_steps.py -c checkpoint/square_ph/diffusion_policy_transformer/train_2/checkpoints/epoch=3000-test_mean_score=1.000.ckpt -o assets/square_ph -d cuda:2 --num_caches '5,7,10,20' --force_recompute

#python HASInfer/analysis/get_optimal_cache_update_steps.py -c checkpoint/transport_ph/diffusion_policy_transformer/train_2/checkpoints/epoch=3350-test_mean_score=0.955.ckpt -o assets/transport_ph -d cuda:2 --num_caches '5,7,10,20' --force_recompute

#python HASInfer/analysis/get_optimal_cache_update_steps.py -c checkpoint/tool_hang_ph/diffusion_policy_transformer/train_2/checkpoints/epoch=1000-test_mean_score=0.682.ckpt -o assets/tool_hang_ph -d cuda:2 --num_caches '5,7,10,20' --force_recompute


#python HASInfer/analysis/get_optimal_cache_update_steps.py -c checkpoint/lift_mh/diffusion_policy_transformer/train_2/checkpoints/latest.ckpt -o assets/lift_mh -d cuda:2 --num_caches '5,7,10,20' --force_recompute

#python HASInfer/analysis/get_optimal_cache_update_steps.py -c checkpoint/can_mh/diffusion_policy_transformer/train_2/checkpoints/latest.ckpt -o assets/can_mh -d cuda:2 --num_caches '5,7,10,20' --force_recompute

#python HASInfer/analysis/get_optimal_cache_update_steps.py -c checkpoint/square_mh/diffusion_policy_transformer/train_2/checkpoints/latest.ckpt -o assets/square_mh -d cuda:2 --num_caches '5,7,10,20' --force_recompute

#python HASInfer/analysis/get_optimal_cache_update_steps.py -c checkpoint/transport_mh/diffusion_policy_transformer/train_2/checkpoints/latest.ckpt -o assets/transport_mh -d cuda:2 --num_caches '5,7,10,20' --force_recompute

#python HASInfer/analysis/get_optimal_cache_update_steps.py -c checkpoint/low_dim/kitchen/diffusion_policy_transformer/train_2/checkpoints/epoch=1750-test_mean_score=0.574.ckpt -o assets/kitchen -d cuda:2 --num_caches '5,7,10,20' --force_recompute

#python HASInfer/analysis/get_optimal_cache_update_steps.py -c checkpoint/low_dim/block_pushing/diffusion_policy_transformer/train_2/checkpoints/epoch=7950-test_mean_score=1.000.ckpt -o assets/block_pushing -d cuda:2 --num_caches '5,7,10,20' --force_recompute

#python HASInfer/analysis/get_optimal_cache_update_steps.py -c checkpoint/pusht/diffusion_policy_transformer/train_2/checkpoints/epoch=0150-test_mean_score=0.752.ckpt -o assets/pusht -d cuda:2 --num_caches '5,7,10,20' --force_recompute
...
from HASInfer.analysis.run_policy import run_policy
from HASInfer.analysis.collect_activations import collect_activations
from HASInfer.analysis.activation_analysis import (
...
from HASInfer.analysis.optimal_cache_scheduler import (
